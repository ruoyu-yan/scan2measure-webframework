...
export const FULL_PIPELINE_STAGES: StageConfig[] = [
  ...
  },
  {
    ...
    scriptPaths: ["src/segmentation/SAM3_room_segmentation.py"],
    condaEnv: "sam3",
    viewType: "2d",
    perPano: false,
  },
  {
    ...
    scriptPaths: ["src/segmentation/SAM3_mask_to_polygons.py"],
    condaEnv: "scan_env",
    viewType: "2d",
    perPano: false,
  },
  {
    ...
    scriptPaths: ["src/segmentation/SAM3_pano_footprint_extraction.py"],
    condaEnv: "sam3",
    viewType: "2d",
    perPano: true,
  },
  ...
  },
  {
    index: 5,
    id: "confirm_matching",
    name: "Confirm Matching",
    description: "Verify pano-to-room assignments before pose estimation",
    scriptPaths: [],
    condaEnv: "scan_env",
  ...
  {
    index: 10,
    id: "confirm_colorization",
    name: "Inspect Colorization",
    description: "Inspect the colored point cloud and select mesh quality before proceeding",
    scriptPaths: [],
    condaEnv: "scan_env",
    viewType: "confirmation",
    perPano: false,
